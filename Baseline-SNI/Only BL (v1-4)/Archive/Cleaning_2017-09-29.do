...
import delimited "U:\Log My Life Study\Survey Data\Qualtrics Data Exports\Baseline\LogMyLife Baseline Questionnaire - (edits 2017-07-11)_September 29, 2017_09.57_formatted.csv", delimiter(comma) varnames(1) case(upper)
...
/*temporarily code 1031's ethnicity w/ race missing until he takes baseline on 10/3/17 */
insobs 1
replace PID = 1031 if PID == . 
replace SEX = 1 if PID == 1031
replace HISP = 1 if PID == 1031
replace RACE = 99 if PID == 1031
