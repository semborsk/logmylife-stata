...
import delimited "U:\Log My Life Study\Survey Data\Qualtrics Data Exports\Baseline\LogMyLife Baseline Questionnaire - (edits 2017-07-11)_September 18, 2017_14.40_formatted.csv", delimiter(comma) varnames(1) case(upper)
...
// TEMPORARY!!!! Add observations for any that don't have a survey file and label them with PID
insobs 1
...
lab def YN_DK_LAB 1"Yes" 0"No" 99"Don't know" -99"Seen but not answered"
