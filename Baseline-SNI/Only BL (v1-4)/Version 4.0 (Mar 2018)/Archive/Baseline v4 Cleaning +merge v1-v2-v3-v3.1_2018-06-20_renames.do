...
import delimited "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Raw Data-Cleaning\Qualtrics Survey Data\Baseline\Version 4.0 (Mar 2018)\LogMyLife Baseline Questionnaire_ver4.0 (Mar2018)_May 29, 2018_11.37_formatted.csv", delimiter(comma) varnames(1) case(upper)
...
append using "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Raw Data-Cleaning\Qualtrics Survey Data\Baseline\Version 2 (edits 2017-07-11)\Cleaned baseline v1-v2 to match v4 dataset ready to merge.dta", nolabel force
append using "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Raw Data-Cleaning\Qualtrics Survey Data\Baseline\Version 3 (Jan 2018)\Cleaned baseline v3 to match v4 dataset ready to merge.dta", nolabel force
append using "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Raw Data-Cleaning\Qualtrics Survey Data\Baseline\Version 3.1 (Feb 2018)\Cleaned baseline v3.1 to match v4 dataset ready to merge_2018-04-03.dta", nolabel force
order INTNAME-CONSENT, first
order PID, first
order RESPONSEID, after(PID)
sort PID
