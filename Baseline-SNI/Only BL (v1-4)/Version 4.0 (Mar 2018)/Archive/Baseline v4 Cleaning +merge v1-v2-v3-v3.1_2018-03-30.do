...
import delimited "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Raw Data-Cleaning\Qualtrics Survey Data\Baseline\Version 4.0 (Mar 2018)\LogMyLife Baseline Questionnaire_ver4.0 (Mar2018)_March 30, 2018_18.23_formatted", delimiter(comma) varnames(1) case(upper)
...
append using "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Raw Data-Cleaning\Qualtrics Survey Data\Baseline\Version 3.1 (Feb 2018)\TEMP REMOVE 1077 cleaned bl v3.1 to match v4 dataset_2018-03-30.dta", nolabel force




//(NOTE: TEMPORARILY DROPPED LAST 75% OF 1077'S BL DATA B/C WAS IN V3.1 AND DIDN'T FIGURE OUT HOW I WANT TO MERGE THEM TOGETHER)
...
//NEED TO RECODE SOME DEMO_RACE FOLKS (LIKE MOORISH RESPONSE OPTION, ETC)
...
//(figure out later) egen CAGESCORE = rowtotal(CAGE2-CAGE4), missing
order CAGESCORE, after(CAGE4)
//(figure out later) gen CAGE_CLIN=. 
