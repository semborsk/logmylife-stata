...
import delimited "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Raw Data-Cleaning\Qualtrics Survey Data\Baseline\Version 4.0 (Mar 2018)\LogMyLife Baseline Questionnaire_ver4.0 (Mar2018)_March 27, 2018_17.28_formatted", delimiter(comma) varnames(1) case(upper)
...
//drop if RESPONSEID == "" | RESPONSEID == "" | RESPONSEID == ""

//append data from Baseline Version 1+2, 3, and 3.1 (cleaned)
//OLD from V1: append using "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Raw Data-Cleaning\Qualtrics Survey Data\Baseline\Version 1 (edits 2017-05-30)\Cleaned 5-30-17 version dataset ready to merge.dta", nolabel force
...
/* change 2004's SEXORI to heterosexual NEED TO UPDATE THIS IN DATA CHANGES TRACKER*/
