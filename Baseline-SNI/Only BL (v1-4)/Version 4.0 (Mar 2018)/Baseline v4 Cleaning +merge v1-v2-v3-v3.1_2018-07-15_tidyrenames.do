...
/*mac remote login*/import delimited "/Volumes/Share/LML_Share/USC LOG MY LIFE STUDY/Data/Quant/Raw Data-Cleaning/Qualtrics Survey Data/Baseline/Version 4.0 (Mar 2018)/LogMyLife Baseline Questionnaire_ver4.0 (Mar2018)_May 29, 2018_11.37_formatted.csv", delimiter(comma) varnames(1) case(upper)

/*Delete all test responses or mistake responses and fix mislabeled PID*/
drop if RESPONSEID == "R_stF9n5DWYzgdzaN" 
drop if RESPONSEID == "R_1FwVRmAmCCIpTr4" /*drop 25% complete 1077 response, since combined w/ 3.1 last 75% and re-entered in v4*/
replace PID = 1123 if RESPONSEID == "R_1q8J5bPCH9so9ev"
replace PID = 1127 if RESPONSEID == "R_pRUAf7AhL2RWtLb"
...
//relabel v4 DERS_SF vars to match (incorrect, but harmonized) earlier versions --> then renaming to corrected/real DERS numbers after merging in other data (updated 4/27/18)
...
//append v1-v2 cleaned to match, v3 cleaned to match and v3.1 cleaned to match 
/*mac remote login*/append using "/Volumes/Share/LML_Share/USC LOG MY LIFE STUDY/Data/Quant/Raw Data-Cleaning/Qualtrics Survey Data/Baseline/Version 2 (edits 2017-07-11)/Cleaned baseline v1-v2 to match v4 dataset ready to merge.dta", nolabel force
/*mac remote login*/append using "/Volumes/Share/LML_Share/USC LOG MY LIFE STUDY/Data/Quant/Raw Data-Cleaning/Qualtrics Survey Data/Baseline/Version 3 (Jan 2018)/Cleaned baseline v3 to match v4 dataset ready to merge.dta", nolabel force
/*mac remote login*/append using "/Volumes/Share/LML_Share/USC LOG MY LIFE STUDY/Data/Quant/Raw Data-Cleaning/Qualtrics Survey Data/Baseline/Version 3.1 (Feb 2018)/Cleaned baseline v3.1 to match v4 dataset ready to merge_2018-04-03.dta", nolabel force
order INTNAME-CONSENT, first
order PID, first
order RESPONSEID, after(PID)
sort PID

//added 4/27/18: rename DERS_SF from harmonized (incorrect) varnames from all versions to actual correct versions from instrument (still need to reverse code relevant items)
rename DERS_SF_1 DERS_SF_1
rename DERS_SF_2 DERS_SF_2
rename DERS_SF_3 DERS_SF_3_oldtemp
rename DERS_SF_6 DERS_SF_3
rename DERS_SF_4 DERS_SF_4
rename DERS_SF_5 DERS_SF_5
rename DERS_SF_3_oldtemp DERS_SF_6
rename DERS_SF_8 DERS_SF_7
rename DERS_SF_9 DERS_SF_8
rename DERS_SF_10 DERS_SF_09
rename DERS_SF_11 DERS_SF_10
rename DERS_SF_12 DERS_SF_11
rename DERS_SF_13 DERS_SF_12
rename DERS_SF_14 DERS_SF_13
rename DERS_SF_15 DERS_SF_14
rename DERS_SF_16 DERS_SF_15
rename DERS_SF_17 DERS_SF_16
rename DERS_SF_18 DERS_SF_17
rename DERS_SF_19 DERS_SF_18
...
// clean recode "other" recruitment site entries for v4 responses



// Make known changes to baseline v4 survey responses:
replace SITE_HOUSED=35 if PID==1102
...
//(generated in earlier v's) gen DEMO_RACE = . 
...
replace DEMO_RACE = 99 if RACE == 9
replace DEMO_RACE = 99 if RACE == 99
replace DEMO_RACE = 99 if RACE == 999

//Recoding/cleaning DEMO_RACE

replace DEMO_RACE=99 if PID==1070 /*SAID "OTHER" race then wrote in "MOORISH" --> need to confirm we want to recode as DEMO_RACE==99 and DEMO_RACEMIN==1 (below)*/
replace DEMO_RACE=99 if PID==1087 /*yes to hisp/lat; seen but not answered to race*/
replace DEMO_RACE=99 if PID==1056 /*NO to hisp/lat; "OTHER" to RACE w/ no text entry*/


/*cleaned racial minority or not dummy variable for NIMH enrollment reporting*/
//(generated in earlier versions) gen DEMO_RACEMIN = . 
...
replace DEMO_RACEMIN=1 if PID==1070
replace DEMO_RACEMIN=99 if PID==1087 /*yes to hisp/lat; seen but not answered to race*/
replace DEMO_RACEMIN=99 if PID==1056 /*NO to hisp/lat; "OTHER" to RACE w/ no text entry*/
...
//Create sum scores of scales and other indicators
/*cage score*/
...
//renames on 7/15/18 to switch to tidyverse format pre-v5.0 merge for Y2RPPR
...
rename	BIRACE_OTHER	RACE_BIRACE_ETH_OTHER_TEXT
...
rename	GENDER_M	GENDER_ID_MALE_SELECTED
rename	GENDER_F	GENDER_ID_FEMALE_SELECTED
rename	GENDER_TM	GENDER_ID_TRANSMALE_SELECTED
rename	GENDER_TF	GENDER_ID_TRANSFEMALE_SELECTED
rename	GENDER_GQNC	GENDER_ID_GQNC_SELECTED
rename	GENDER_OTHER	GENDER_ID_OTHER_SELECTED
rename	GENDER_OTHER_TEXT	GENDER_ID_OTHER_TEXT
rename	SEXORI	SEXUAL_ORIENTATION_ID
rename	SEXORI_OTHER	SEXUAL_ORIENTATION_ID_OTHER
rename	SEXATTR	SEXUAL_ORIENTATION_ATTRACTION
...
rename	RESEARCHTYPE_HIV	RESEARCH_TYPE_HIV
rename	RESEARCHTYPE_SU	RESEARCH_TYPE_SUBSTANCE_USE
rename	RESEARCHTYPE_SEX	RESEARCH_TYPE_SEX_BEHAVIOR
rename	RESEARCHTYPE_OTHER	RESEARCH_TYPE_OTHER
rename	RESEARCHTYPE_DK	RESEARCH_TYPE_DONT_KNOW
rename	RESEARCHTYPE_OTHER_TEXT	RESEARCH_TYPE_OTHER_TEXT
...
rename	ROMREL_PTNRSGNDR_M	ROMANTIC_REL_PARTNERGENDER_M
rename	ROMREL_PTNRSGNDR_F	ROMANTIC_REL_PARTNERGENDER_F
rename	ROMREL_PTNRSGNDR_TM	ROMANTIC_REL_PARTNERGENDER_TM
rename	ROMREL_PTNRSGNDR_TF	ROMANTIC_REL_PARTNERGENDER_TF
rename	ROMREL_PTNRSGNDR_GQ	ROMANTIC_REL_PARTNERGENDER_GQNC
rename	ROMREL_PTNRSGNDR_OTHER	ROMANTIC_REL_PARTNERGENDER_OTHER
rename	ROMREL_PTNRSGNDR_OTHER_TXT	ROMANTIC_REL_PARTNERGENDER_OTEXT
...
rename	STAYBEFOREHOUSED_OTHER	PLACESLIVED_H_MAIN_PREHOUSEDTEXT
rename	TIMEHOMELESS_BEFOREH	HOMELESS_DURATION_H_PREHOUSEDEP
rename	TIMEHOMELESS_RECENT	HOMELESS_DURATION_UH_CURRENTEP
rename	UH_LIVSIT_3MO_17	PLACESLIVED_UH_3MO_STREET
rename	UH_LIVSIT_3MO_18	LIVING_SITUATIONS_UH_3MO_SQUAT
rename	UH_LIVSIT_3MO_19	PLACESLIVED_UH_3MO_VEHICLEMETRO
rename	UH_LIVSIT_3MO_1	PLACESLIVED_UH_3MO_FAMHOME
rename	UH_LIVSIT_3MO_2	PLACESLIVED_UH_3MO_FOSTHOME
rename	UH_LIVSIT_3MO_3	PLACESLIVED_UH_3MO_RELHOME
rename	UH_LIVSIT_3MO_4	PLACESLIVED_UH_3MO_FRIENDHOME
rename	UH_LIVSIT_3MO_5	PLACESLIVED_UH_3MO_PARTNERHOME
rename	UH_LIVSIT_3MO_6	PLACESLIVED_UH_3MO_STRANGER_HOME
rename	UH_LIVSIT_3MO_7	PLACESLIVED_UH_3MO_GROUP_HOME
rename	UH_LIVSIT_3MO_8	PLACESLIVED_UH_3MO_SHELTER_Y_30D
//	UH_LIVSIT_3MO_21	PLACESLIVED_UH_3MO_SHELTER_A_30D
rename	UH_LIVSIT_3MO_9	PLACESLIVED_UH_3MO_SHELTER_A_LT
rename	UH_LIVSIT_3MO_10	PLACESLIVED_UH_3MO_SHELTER_Y_LT
rename	UH_LIVSIT_3MO_11	PLACESLIVED_UH_3MO_HOTEL_MOTEL
rename	UH_LIVSIT_3MO_12	PLACESLIVED_UH_3MO_SOBER_LIVING
rename	UH_LIVSIT_3MO_13	PLACESLIVED_UH_3MO_JAIL
rename	UH_LIVSIT_3MO_14	PLACESLIVED_UH_3MO_TLP
rename	UH_LIVSIT_3MO_15	PLACESLIVED_UH_3MO_PSH
rename	UH_LIVSIT_3MO_16	PLACESLIVED_UH_3MO_MYAPARTMENT
...
rename	MHDX_ADHD	DX_MENTAL_ADHD
rename	MHDX_PTSD	DX_MENTAL_PTSD
rename	MHDX_ODCD	DX_MENTAL_ODCD
rename	MHDX_MDD	DX_MENTAL_MAJORDEPRESSION
rename	MHDX_BPD	DX_MENTAL_BIPOLAR
rename	MHDX_SCHIZ	DX_MENTAL_SCHIZOPHRENIAAFFECTIVE
rename	MHDX_ANX	DX_MENTAL_ANXIETYPANIC
rename	MHDX_PD	DX_MENTAL_PERSONALITYD
rename	MHDX_OTHER	DX_MENTAL_OTHER_SELECTED
rename	MHDX_OTHER_TXT	DX_MENTAL_OTHER_TEXT
...
rename	MHC12MO_RX	MENTAL_HEALTH_TX_12MO_MEDICATION
rename	MHC12MO_THER	MENTAL_HEALTH_TX_12MO_THERAPY
rename	MHC12MO_ER	MENTAL_HEALTH_TX_12MO_ER
rename	MHC12MO_INPAT	MENTAL_HEALTH_TX_12MO_INPATIENT
rename	MHC12MO_UNMET	MENTAL_HEALTH_TX_12MO_UNMETNEED
rename	MHC_NEEDCURR	MENTAL_HEALTH_TX_CURRENT_NEED
rename	DERS_SF_1	DERS_SF_AWARENESS_1_BL
rename	DERS_SF_2	DERS_SF_CLARITY_2_BL
rename	DERS_SF_3	DERS_SF_CLARITY_3_BL
rename	DERS_SF_4	DERS_SF_AWARENESS_4_BL
rename	DERS_SF_5	DERS_SF_CLARITY_5_BL
rename	DERS_SF_6	DERS_SF_AWARENESS_6_BL
rename	DERS_SF_7	DERS_SF_NONACCEPT_7
rename	DERS_SF_8	DERS_SF_GOALS_8
rename	DERS_SF_09	DERS_SF_IMPULSE_9
rename	DERS_SF_10	DERS_SF_STRATEGIES_10
rename	DERS_SF_11	DERS_SF_GOALS_11
rename	DERS_SF_12	DERS_SF_NONACCEPT_12
rename	DERS_SF_13	DERS_SF_GOALS_13
rename	DERS_SF_14	DERS_SF_IMPULSE_14
rename	DERS_SF_15	DERS_SF_STRATEGIES_15
rename	DERS_SF_16	DERS_SF_NONACCEPT_16
rename	DERS_SF_17	DERS_SF_IMPULSE_17
rename	DERS_SF_18	DERS_SF_STRATEGIES_18
...
rename	SEX3MO_PARTGNDR_1	SEX_3MO_PARTNER_GENDER_MALE
rename	SEX3MO_PARTGNDR_2	SEX_3MO_PARTNER_GENDER_FEMALE
rename	SEX3MO_PARTGNDR_3	SEX_3MO_PARTNER_GENDER_TRANSMALE
rename	SEX3MO_PARTGNDR_4	SEX_3MO_PARTNER_GENDER_TRANSFEML
rename	SEX3MO_PARTGNDR_5	SEX_3MO_PARTNER_GENDER_GQNC
rename	SEX3MO_PARTGNDR_6	SEX_3MO_PARTNER_GENDER_OTHER
rename	SEX3MO_PARTGNDR_6_TEXT	SEX_3MO_PARTNER_GENDER_OTHER_TXT
rename	SEX3MO_TYPES_1	SEX_3MO_TYPES_ANAL_WCONDOM
rename	SEX3MO_TYPES_2	SEX_3MO_TYPES_ANAL_NOCONDOM
rename	SEX3MO_TYPES_3	SEX_3MO_TYPES_ORAL_WCONDOM
rename	SEX3MO_TYPES_4	SEX_3MO_TYPES_ORAL_NOCONDOM
rename	SEX3MO_TYPES_5	SEX_3MO_TYPES_VAGINAL_WCONDOM
rename	SEX3MO_TYPES_6	SEX_3MO_TYPES_VAGINAL_NOCONDOM
rename	SEX3MO_PARTNUM	SEX_3MO_PARTNER_NUM_VAGINAL_ANAL
rename	SEX3MO_PARTBIOSEX	SEX_3MO_PARTNER_BIOSEX
rename	SEX3MO_CONDOMFREQ	SEX_3MO_CONDOM_FREQ
rename	SEX3MO_CNTRCPTV_1	SEX_3MO_CONTRACEPTYPES_NONE
rename	SEX3MO_CNTRCPTV_2	SEX_3MO_CONTRACEPTYPES_CONDOMS
rename	SEX3MO_CNTRCPTV_3	SEX_3MO_CONTRACEPTYPES_BC_ORAL
rename	SEX3MO_CNTRCPTV_4	SEX_3MO_CONTRACEPTYPES_BC_PATCH
rename	SEX3MO_CNTRCPTV_5	SEX_3MO_CONTRACEPTYPES_IUD
rename	SEX3MO_CNTRCPTV_6	SEX_3MO_CONTRACEPTYPES_WITHDRAW
rename	SEX3MO_CNTRCPTV_7	SEX_3MO_CONTRACEPTYPES_FAM
rename	SEX3MO_CNTRCPTV_8	SEX_3MO_CONTRACEPTYPES_OTHER
rename	SEX3MO_CNTRCPTV_99	SEX_3MO_CONTRACEPTYPES_UNSURE
rename	SEX3MO_CNTRCPTV_9_TEXT	SEX_3MO_CONTRACEPTYPES_OTHER_TXT
rename	SEX3MO_CNTRCPTV_FAM	SEX_3MO_CONTRACEPTYPES_FAM_APP
rename	SEX3MO_CNTRCPTV_PLAN	SEX_3MO_CONTRACEPTYPES_PLANB
rename	SEX3MO_SUIFREQ	SEX_3MO_INTOXICATED_FREQ
rename	SEX3MO_HIVCONVO	SEX_3MO_NO_HIV_TALK_BEFORE
...
rename	HIVP_TESTLOC_OTHER	HIV_POS_TESTED_WHERE_OTHER
...
rename	STI_POS_OTHER	STI_POSEVER_OTHER_SELECTED
rename	STI_POS_88	STI_POSEVER_NO_RESULTS_RETRIEVED
rename	STI_POS_0	STI_POSEVER_NONE
rename	STI_POS_OTHER_TXT	STI_POSEVER_OTHER_TEXT
...
rename	SUEVER_TOB	TOBACCO_EVER
rename	SUEVER_ALC	ALCOHOL_EVER
rename	SUEVER_MJ	MARIJUANA_EVER
rename	SUEVER_METH	METH_EVER
rename	SUEVER_MDMA	MDMA_EVER
rename	SUEVER_SMJ	SYNTHETIC_MJ_EVER
rename	SUEVER_HALL	HALLUCINOGEN_EVER
rename	SUEVER_PDM	RXMISUSE_EVER
rename	SUEVER_HER	HEROIN_EVER
rename	SUEVER_COC	COCAINE_EVER
rename	SUEVER_CRACK	CRACK_EVER
rename	SUEVER_INHAL	INHALANTS_EVER
rename	SUEVER_STEROID	STEROID_EVER
rename	SUEVER_N20	NITROUS_EVER
rename	SUEVER_KET	KETAMINE_EVER
rename	SUEVER_PCP	PCP_EVER
rename	SUEVER_OTHER	OTHERDRUG_EVER_SELECTED
rename	SUEVER_NONE	NO_SUBSTANCE_USE_EVER
rename	SUEVER_OTHER_TEXT	OTHERDRUG_EVER_TEXT
...
rename	TOBACCO_VAPEFREQ	TOBACCO_FREQ_VAPE
...
rename	MARJ_AMTWK_PLNT	MARIJUANA_QUANT_30DAY_PLANTPERWK
rename	MARJ_AMTWK_CONC	MARIJUANA_QUANT_30DAY_CONCPERWK
...
rename	IVDU_NEEDLEEXCH	NEEDLE_EXCHANGE_USE_EVER
...
rename	SUTX_PASTYEAR	SU_TREATMENT_PAST_YEAR
rename	CAGE2	CAGE_2_ANNOYEDBYCRITICISM
rename	CAGE1	CAGE_1_CUTDOWN
rename	CAGE3	CAGE_3_GUILTY
rename	CAGE4	CAGE_4_EYEOPENER
rename	SUCOST_30D_ALC	SPEND_SU_30DAY_ALCOHOL
rename	SUCOST_30D_ALC_UND50TXT	SPEND_SU_30DAY_ALCOHOL_SUB50TXT
rename	SUCOST_30D_MARJ	SPEND_SU_30DAY_MARIJUANA
rename	SUCOST_30D_MARJ_UND50TXT	SPEND_SU_30DAY_MARIJUANA_SUB50TX
rename	SUCOST_30D_ILDRUG	SPEND_SU_30DAY_OTHDRUGS
rename	SUCOST_30D_ILDRUG_UND50TXT	SPEND_SU_30DAY_OTHDRUGS_SUB50TXT
...
rename	CELL_BILL_OTHER1TXT	PHONE_PAYBILL_FAMILYOTHER_TEXT
rename	CELL_BILL_OTHER2TXT	PHONE_PAYBILL_OTHER_TEXT
...
rename	VICT_IPV	VICTIM_IPV_SINCE_HOMELESS
rename	PERP_IPV	PERPETRATE_IPV_SINCE_HOMELESS
rename	VICT_ASSLT	VICTIM_ASSAULT_SINCE_HOMELESS
rename	PERP_ASSLT	PERPETRATE_ASSAULT_SINCEHOMELESS
rename	GANG_CURFMR	GANG_MEMBER_EVER
rename	GANG_CURACTV	GANG_MEMBER_CURRENT
...
drop	Q569	
//	Q524	SPECIAL_NOTE_BL_ANY
//	Q524_1_TEXT	SPECIAL_NOTE_BL_TEXT
drop	Q525	
drop	HIVP_MEDS_WHYNOT_6_TEXTTOPICS
