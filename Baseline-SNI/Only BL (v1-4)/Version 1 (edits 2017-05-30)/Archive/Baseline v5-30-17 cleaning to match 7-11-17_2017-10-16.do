...
/*NEED TO DECIDE WHICH 1014 TO DROP*/
...
lab val MH_CURRENT* SDSF34_LAB "Past 30day extent of issues w/ ADHD (in original BL version only)"


//NEED TO FIGURE OUT WHAT TO DO WITH F/U'S FOR MH_CURRENT IN ORIGINAL VERSION: had follow-ups for each endorsed diagnosis to answer the extent of problems from that issue. 
