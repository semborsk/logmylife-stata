...
replace HOMELESS_DURATION_LIFETIME = DURATION_HOMELESSNESS_LIFETIME if HOMELESS_DURATION_LIFETIME == .
replace HOUSED_DURATION_CURRENTPROGRAM = DURATION_HOUSED_CURRENT_PROGRAM if HOUSED_DURATION_CURRENTPROGRAM == .
drop DURATION_H*
