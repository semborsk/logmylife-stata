...
///*mac remote login*/import delimited "/Volumes/Share/LML_Share/USC LOG MY LIFE STUDY/Data/Quant/Raw Data-Cleaning/Qualtrics Survey Data/Baseline-SNI/Version 5.0 (May 2018)/LogMyLife Baseline-SNI+Questionnaire_ver5.0 (May2018)_July+ 15, 2018_14.58_formatted.csv", delimiter(comma) varnames(1) case(upper)
/*in-office path*/ import delimited "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Raw Data-Cleaning\Qualtrics Survey Data\Baseline-SNI\Baseline-SNI (v5+)\Version 6.0 (July 2018)\LML BL-SNI Questionnaire_ver6.0 (July2018)_July 30 2018_13.27_format.csv", delimiter (comma) varnames (1) case (upper)
...
gen HOUSED = 1 if PID_MASTER >999 & PID_MASTER <2000
replace HOUSED = 1 if PID_MASTER >2999 & PID_MASTER <4000
replace HOUSED = 0 if PID_MASTER > 1999 & PID_MASTER < 3000
replace HOUSED = 0 if PID_MASTER >3999 & PID_MASTER <5000

//append v1-5 clean/tidy data
append using "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Clean Datasets\Merged Person-Level Survey Datasets\BLSNI_v1-5_tidy_2018-07-18.dta", force
...
//rename variables that I'd missed before...(yeah...this is sloppy SORRY 
rename HOUSINGPROGS_EVER_21 PLACESLIVED_SINCEHMLS_STRNGRHOME
rename LIVING_SITUATIONS_UH_3MO_SQUAT PLACESLIVED_UH_3MO_SQUAT  
rename DURATION_HOMELESSNESS_LIFETIME HOMELESS_DURATION_LIFETIME
rename DURATION_HOUSED_CURRENT_PROGRAM HOUSED_DURATION_CURRENTPROGRAM

//revert all non- 1___ 2___ PID's back
