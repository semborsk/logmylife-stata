...
replace PID_MASTER = PID_BL if PID_BL != .


//merge SNI v1-4 cleantidy
/*remote login mac version*/merge 1:1 PID_MASTER using "/Volumes/Share/LML_Share/USC LOG MY LIFE STUDY/Data/Quant/Clean Datasets/Clean SNI Questionnaire Datasets/SNI_RELappend_V234_tidyrename.dta", force
///*in-office version*/ 
