...
/*in-office path*/ import delimited "S:\LML_Share\USC LOG MY LIFE STUDY\Data\Quant\Raw Data-Cleaning\Qualtrics Survey Data\Baseline\Version 5.0 (May 2018)\LogMyLife Baseline-SNI+Questionnaire_ver5.0 (May2018)_July+ 15, 2018_14.58_formatted", delimieter (comma) varnames (1) case (upper)
...
replace GENDER_CISYN = 1 if GENDER_ID_MALE_SELECTED==1 & SEX_AT_BIRTH==1 & GENDER_ID_TRANSMALE_SELECTED==. & GENDER_ID_TRANSFEMALE_SELECTED==. & GENDER_ID_GQNC_SELECTED ==. & GENDER_ID_OTHER_TEXT==. 
replace GENDER_CISYN = 1 if GENDER_ID_FEMALE_SELECTED==1 & SEX_AT_BIRTH==2 & GENDER_ID_TRANSMALE_SELECTED==. & GENDER_ID_TRANSFEMALE_SELECTED==. & GENDER_ID_GQNC_SELECTED ==. & GENDER_ID_OTHER_TEXT==. 
replace GENDER_CISYN = 999 if GENDER_ID_MALE_SELECTED == . & GENDER_ID_FEMALE_SELECTED == . & GENDER_ID_TRANSMALE_SELECTED == . & GENDER_ID_TRANSFEMALE_SELECTED == . & GENDER_ID_GQNC_SELECTED == . & GENDER_ID_OTHER_TEXT == .
...
append using "/Volumes/Share/LML_Share/USC LOG MY LIFE STUDY/Data/Quant/Clean Datasets/Clean Baseline Questionnaire Datasets/Basline v1-4_cleantomerge_tidyverse_7.15.18.dta", force
